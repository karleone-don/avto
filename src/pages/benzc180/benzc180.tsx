...
const BenzC180  : React.FC = () => {
  const [currentPhotoIndex, setCurrentPhotoIndex] = useState(0);
  const [selectedOption, setSelectedOption] = useState(0);
  const [activeTab, setActiveTab] = useState(0);

  const photos: Photo[] = [
    { id: 1, url: 'https://syndicateauto.kz/_next/image?url=https%3A%2F%2Fsyndicateauto.kz%2Fstrapi%2Fuploads%2Flarge_7_M301776_7b081a3e8f.jpg&w=1024&q=100' },
    { id: 2, url: 'https://syndicateauto.kz/_next/image?url=https%3A%2F%2Fsyndicateauto.kz%2Fstrapi%2Fuploads%2Flarge_7_M301772_15538411c4.jpg&w=1024&q=100' },
    { id: 3, url: 'https://syndicateauto.kz/_next/image?url=https%3A%2F%2Fsyndicateauto.kz%2Fstrapi%2Fuploads%2Flarge_7_M301782_60e6177b53.jpg&w=1024&q=100' },
    { id: 4, url: 'https://syndicateauto.kz/_next/image?url=https%3A%2F%2Fsyndicateauto.kz%2Fstrapi%2Fuploads%2Flarge_7_M301784_1e79a4440e.jpg&w=1024&q=100' },
    { id: 5, url: 'https://syndicateauto.kz/_next/image?url=https%3A%2F%2Fsyndicateauto.kz%2Fstrapi%2Fuploads%2Flarge_7_M301796_1c76e56779.jpg&w=1024&q=100' },
    { id: 6, url: 'https://syndicateauto.kz/_next/image?url=https%3A%2F%2Fsyndicateauto.kz%2Fstrapi%2Fuploads%2Flarge_7_M301800_28c370af45.jpg&w=1024&q=100' },
  ];
    ...
    <div className="zeekr-container">
      ...
      <section className="block block-1">
        ...
        <div className="content-section">
          <h1 className="title">Mercedes-Benz C180 2018</h1>
          <p className="description">
            Аренда Mercedes-Benz C180 2018 по выгодным ценам с премиальным дизайном и комфортом
          </p>
          ...
          <div className="specs-table">
            ...
            <div className="spec-item">
              ...
              <div className="spec-value">9л/100 км</div>
            </div>
            <div className="spec-item">
          ...
          {activeTab === 0 ? (
            <div className="specs-big-wrapper no-scrollbar">
              <table className="specs-grid-table">
                ...
                <tbody>
                  <tr>
                    <td>5</td><td>150</td><td>1.6L</td><td>Седан</td><td>Задний</td>
                    <td>9.8 сек</td><td>Черный</td><td>Черный</td><td>220 км/ч</td><td>Автомат</td>
                    <td>9л/100 км</td><td>2018</td>
                  </tr>
                </tbody>
              </table>
            </div>
      ...
      <section className="block block-3">
        <div className="block-content">
          <h2 className="block-title">Аренда Mercedes-Benz C180 2018 в Алматы</h2>
          <p className="description">
            Условия и цены на прокат автомобиля Mercedes-Benz C180 2018, включая гибкие тарифы на разные сроки аренды, от одного дня до месяца, с возможностью онлайн-бронирования и подробной информацией о доступности в Алматы.            </p>
          <div className="steps-container">
            <div className="step-island">
              <div className="step-number">01</div>
              <div className="island-header">Преимущества аренды в Алматы</div>
              <div className="island-body">Почему стоит выбрать Mercedes-Benz C180 для поездок по Алматы, благодаря его премиальному дизайну, мощности, экономичному расходу топлива и просторному салону, идеально подходящему для деловых поездок и особых случаев.</div>
            </div>
            <div className="step-island">
              <div className="step-number">02</div>
              <div className="island-header">Особенности автомобиля для аренды</div>
              <div className="island-body">Узнайте о ключевых характеристиках Mercedes-Benz C180 2018, таких как турбированный двигатель, стильный внешний вид, высокотехнологичный салон и адаптация к городским дорогам Алматы, что делает его отличным выбором для любого путешествия.</div>
            </div>
          </div>
        </div>
      </section>
